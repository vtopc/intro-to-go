...
0. Avoid Concurrency.
    ...
    and async solution consumes [50%](examples/workerpool/README.md#benchmarks)–[100%](examples/group/README.md#benchmarks) more memory.
...
- either use [errgroup](https://pkg.go.dev/golang.org/x/sync/errgroup) with panic recovery, [e.g.](examples/group/main.go);
