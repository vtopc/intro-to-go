...
0. Avoid Concurrency.
    ...
    e.g. there is no speed benefit in [this example](examples/2workerpool/README.md) for **one** CPU,
    and async solution consumes [50%](examples/2workerpool/README.md#benchmarks)–[100%](examples/3group/README.md#benchmarks) more memory.
...
- either use [errgroup](https://pkg.go.dev/golang.org/x/sync/errgroup) with panic recovery, [e.g.](examples/3group/main.go);
